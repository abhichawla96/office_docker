							...
							<fo:table-body >
								<fo:table-row>
									<fo:table-cell padding-left="15mm" >
										...
										<fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">Sincerely,</fo:block>
									</fo:table-cell>
								</fo:table-row>
					            ...
					            <fo:table-row>
					              <fo:table-cell border-after-width="4px" padding-left="15mm">
									...
									<fo:table-cell padding-left="-60mm">
										...
										<fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">Sales Support</fo:block>
